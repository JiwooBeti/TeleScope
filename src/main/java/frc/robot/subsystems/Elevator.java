...
public class Elevator extends SubsystemBase {
    private MotorController elevatorLeft, elevatorRight;
    private DigitalInput limitSwitchA, limitSwitchB;
    private Encoder encoderOne, encoderTwo;
    private double leftSpeed, rightSpeed;

    public Elevator(MotorController elevatorLeft, MotorController elevatorRight, DigitalInput limitSwitchA, DigitalInput limitSwitchB, Encoder encoderOne, Encoder encoderTwo) {
